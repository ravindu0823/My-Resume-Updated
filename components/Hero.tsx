...
const Hero = ({ mainData }: HeroProps) => {
  ...
  return (
    <section
      ...
      } relative min-h-screen w-full mx-auto overflow-hidden pt-12 lg:pt-0`}
    >
      ...
      <div className="py-16 lg:py-48 flex flex-col-reverse lg:flex-row justify-around gap-10 lg:gap-0">
        <div className="flex flex-col gap-4 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-4 md:mx-6 xl:mx-0">
          <div className="flex items-center gap-1">
            <Image
              ...
              src={wavingHand}
            />
            <p className="text-lg md:text-xl mt-2 md:mt-1.5">Hello There</p>
          </div>
        ...
        <div className="relative mx-auto lg:mx-0 mt-12 md:mt-16 lg:mt-0">
          ...
          <div
            className={`absolute grid -top-6 -left-12 lg:-top-14 lg:-left-32 w-16 h-16 md:w-20 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
          ...
          <div
            className={`absolute grid -top-20 left-20 lg:-top-24 lg:left-16 w-16 h-16 md:w-20 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
              className="h-8 w-8 md:h-10 md:w-10 object-cover"
          ...
          <div
            className={`absolute grid -top-6 -left-12 lg:top-32 lg:-left-40 w-16 h-16 md:w-20 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
              className="h-8 w-8 md:h-10 md:w-10 object-cover"
          ...
          <div
            className={`absolute grid top-0 -right-12 lg:-right-4 w-14 h-14 md:w-20 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
              className="h-8 w-8 md:h-10 md:w-10 object-cover"
          ...
          <div
            className={`absolute grid bottom-[4rem] md:bottom-24 -right-16 md:-right-20 lg:bottom-16 lg:-right-12 w-12 h-12 md:w-20 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
          ...
          <div
            className={`absolute grid bottom-0 right-56 lg:-bottom-16 lg:right-16 w-14 md:w-20 h-14 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
          ...
          <div
            className={`absolute grid -bottom-10 -right-8 lg:-bottom-14 lg:right-80 w-14 md:w-20 h-14 md:h-20 ${classNames} hover:scale-110 transition-transform duration-300 ease-in-out`}
          >
            <Image
              alt="tech-stack"
              className="h-10 w-10 object-cover"
